...
=================
   ...
   * [Database Administration Statements](#database-administration-statements)
      ...
      * [Table Maintenance Statements](#table-maintenance-statements)
         * [ANALYZE TABLE Statements](#analyze-table-statements)
...
```
mysql> analyze local table t;
+-------------+---------+----------+----------+
| Table       | Op      | Msg_type | Msg_text |
+-------------+---------+----------+----------+
| test.t_0000 | analyze | status   | OK       |
| test.t_0001 | analyze | status   | OK       |
| test.t_0002 | analyze | status   | OK       |
| test.t_0003 | analyze | status   | OK       |
| test.t_0004 | analyze | status   | OK       |
| test.t_0005 | analyze | status   | OK       |
+-------------+---------+----------+----------+
